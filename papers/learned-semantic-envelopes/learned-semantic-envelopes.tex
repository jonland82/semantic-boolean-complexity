...
gap-normalized calibration and prove that, in addition to coverage, it gives
a deterministic per-instance lower bound on the fraction of analytic width
removed.  This turns interval efficiency itself into a certificate.  We apply
